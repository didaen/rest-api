<?php
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, "https://www.googleapis.com/youtube/v3/channels?part=snippet, statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyBbmL8Z4IYMXrZo9wxwzHmCEIHfpRNpnl8");


curl_setopt($curl, CURLOPT_RETURNTRANSFER, 1);
// Bila ingin yang dikembalikan berupa string, parameter ke 3 true atau 1
 
$result = curl_exec($curl);
curl_close($curl);

// Apabila ada parameter ke-2 true, maka yang dikembalikan berupa array associative
